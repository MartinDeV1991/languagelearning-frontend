	...
	useEffect(() => {
		...
		class Effect {
			...
			update() {
				...
				this.totalParticlesCount = this.particlesArray.filter(
					(particle) =>
						particle.originX < this.width * (number / totalNumber) &&
						particle.originX > this.width * ((number - 1) / totalNumber)
				).length;

				this.doneParticlesCount = this.particlesArray.filter(
					(particle) =>
						particle.done &&
						particle.originX < this.width * (number / totalNumber) &&
						particle.originX > this.width * ((number - 1) / totalNumber)
